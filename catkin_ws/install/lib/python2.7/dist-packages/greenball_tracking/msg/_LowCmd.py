...
"""autogenerated by genpy from greenball_tracking/LowCmd.msg. Do not edit."""
import codecs
import sys
...
class LowCmd(genpy.Message):
  ...
  _type = "greenball_tracking/LowCmd"
...
uint8[3] reserve"""
  ...
  _slot_types = ['uint8[2]','uint8','uint8','uint32[2]','uint32[2]','uint16','greenball_tracking/MotorCmd[20]','greenball_tracking/BmsCmd','uint8[40]','uint32','uint32']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.motorCmd is None:
        self.motorCmd = [greenball_tracking.msg.MotorCmd() for _ in range(20)]
      if self.bms is None:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.motorCmd = []
      for i in range(0, 20):
        val1 = greenball_tracking.msg.MotorCmd()
        _x = val1
        start = end
        end += 21
