...
"""autogenerated by genpy from greenball_tracking/LowState.msg. Do not edit."""
import codecs
import sys
...
class LowState(genpy.Message):
  _md5sum = "481f8a83f729a25e7cc170da192f80f9"
  _type = "greenball_tracking/LowState"
...
float32 y
float32 z"""
  __slots__ = ['head','levelFlag','frameReserve','SN','version','bandWidth','imu','motorState','bms','footForce','footForceEst','tick','wirelessRemote','reserve','crc','eeForceRaw','eeForce','position','velocity','velocity_w']
  _slot_types = ['uint8[2]','uint8','uint8','uint32[2]','uint32[2]','uint16','greenball_tracking/IMU','greenball_tracking/MotorState[20]','greenball_tracking/BmsState','int16[4]','int16[4]','uint32','uint8[40]','uint32','uint32','greenball_tracking/Cartesian[4]','greenball_tracking/Cartesian[4]','greenball_tracking/Cartesian','greenball_tracking/Cartesian','greenball_tracking/Cartesian']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       head,levelFlag,frameReserve,SN,version,bandWidth,imu,motorState,bms,footForce,footForceEst,tick,wirelessRemote,reserve,crc,eeForceRaw,eeForce,position,velocity,velocity_w
    ...
    if args or kwds:
      ...
      if self.eeForceRaw is None:
        self.eeForceRaw = [greenball_tracking.msg.Cartesian() for _ in range(4)]
      if self.eeForce is None:
        self.eeForce = [greenball_tracking.msg.Cartesian() for _ in range(4)]
      if self.position is None:
        self.position = greenball_tracking.msg.Cartesian()
      if self.velocity is None:
        self.velocity = greenball_tracking.msg.Cartesian()
      if self.velocity_w is None:
        self.velocity_w = greenball_tracking.msg.Cartesian()
    else:
      self.head = b'\0'*2
      self.levelFlag = 0
      self.frameReserve = 0
