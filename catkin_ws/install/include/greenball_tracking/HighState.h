// Generated by gencpp from file greenball_tracking/HighState.msg
// DO NOT EDIT!


#ifndef GREENBALL_TRACKING_MESSAGE_HIGHSTATE_H
#define GREENBALL_TRACKING_MESSAGE_HIGHSTATE_H
...
struct HighState_
{
  ...
  (void)_alloc;
      ...
      footPosition2Body.assign( ::greenball_tracking::Cartesian_<ContainerAllocator> (_alloc));

      footSpeed2Body.assign( ::greenball_tracking::Cartesian_<ContainerAllocator> (_alloc));
  ...
  _rangeObstacle_type rangeObstacle;
   ...
   typedef boost::array< ::greenball_tracking::Cartesian_<ContainerAllocator> , 4>  _footPosition2Body_type;
  _footPosition2Body_type footPosition2Body;

   typedef boost::array< ::greenball_tracking::Cartesian_<ContainerAllocator> , 4>  _footSpeed2Body_type;
  ...
  typedef boost::shared_ptr< ::greenball_tracking::HighState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::greenball_tracking::HighState_<ContainerAllocator> const> ConstPtr;

}; // struct HighState_

typedef ::greenball_tracking::HighState_<std::allocator<void> > HighState;

typedef boost::shared_ptr< ::greenball_tracking::HighState > HighStatePtr;
typedef boost::shared_ptr< ::greenball_tracking::HighState const> HighStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::greenball_tracking::HighState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::greenball_tracking::HighState_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::greenball_tracking::HighState_<ContainerAllocator1> & lhs, const ::greenball_tracking::HighState_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::greenball_tracking::HighState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::greenball_tracking::HighState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::greenball_tracking::HighState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::greenball_tracking::HighState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::greenball_tracking::HighState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::greenball_tracking::HighState_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::greenball_tracking::HighState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::greenball_tracking::HighState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x7904f43019dadf76ULL;
  static const uint64_t static_value2 = 0x40d573b4c14b9066ULL;
};

template<class ContainerAllocator>
struct DataType< ::greenball_tracking::HighState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::greenball_tracking::HighState_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::greenball_tracking::HighState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::greenball_tracking::HighState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::greenball_tracking::HighState_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.footPosition2Body.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::greenball_tracking::Cartesian_<ContainerAllocator> >::stream(s, indent + "    ", v.footPosition2Body[i]);
    }
    ...
    for (size_t i = 0; i < v.footSpeed2Body.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::greenball_tracking::Cartesian_<ContainerAllocator> >::stream(s, indent + "    ", v.footSpeed2Body[i]);
    }
...
#endif // GREENBALL_TRACKING_MESSAGE_HIGHSTATE_H
