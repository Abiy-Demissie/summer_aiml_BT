...
(cl:defmethod cl:initialize-instance :after ((m <BmsCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BmsCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name greenball_tracking-msg:<BmsCmd> is deprecated: use greenball_tracking-msg:BmsCmd instead.")))

(cl:ensure-generic-function 'off-val :lambda-list '(m))
(cl:defmethod off-val ((m <BmsCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader greenball_tracking-msg:off-val is deprecated.  Use greenball_tracking-msg:off instead.")
  (off m))
