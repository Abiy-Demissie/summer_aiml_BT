...
(cl:defclass <HighCmd> (roslisp-msg-protocol:ros-message)
  ((head
   ...
   (bms
    :reader bms
    :initarg :bms
    :type greenball_tracking-msg:BmsCmd
    :initform (cl:make-instance 'greenball_tracking-msg:BmsCmd))
   (led
    :reader led
    :initarg :led
    :type (cl:vector greenball_tracking-msg:LED)
   :initform (cl:make-array 4 :element-type 'greenball_tracking-msg:LED :initial-element (cl:make-instance 'greenball_tracking-msg:LED)))
   (wirelessRemote
...
(cl:defmethod cl:initialize-instance :after ((m <HighCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HighCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name greenball_tracking-msg:<HighCmd> is deprecated: use greenball_tracking-msg:HighCmd instead.")))
...
(cl:defmethod mode-val ((m <HighCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader greenball_tracking-msg:mode-val is deprecated.  Use greenball_tracking-msg:mode instead.")
  (mode m))

(cl:ensure-generic-function 'gaitType-val :lambda-list '(m))
(cl:defmethod gaitType-val ((m <HighCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader greenball_tracking-msg:gaitType-val is deprecated.  Use greenball_tracking-msg:gaitType instead.")
  (gaitType m))

(cl:ensure-generic-function 'speedLevel-val :lambda-list '(m))
(cl:defmethod speedLevel-val ((m <HighCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader greenball_tracking-msg:speedLevel-val is deprecated.  Use greenball_tracking-msg:speedLevel instead.")
  (speedLevel m))

(cl:ensure-generic-function 'footRaiseHeight-val :lambda-list '(m))
(cl:defmethod footRaiseHeight-val ((m <HighCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader greenball_tracking-msg:footRaiseHeight-val is deprecated.  Use greenball_tracking-msg:footRaiseHeight instead.")
  (footRaiseHeight m))

(cl:ensure-generic-function 'bodyHeight-val :lambda-list '(m))
(cl:defmethod bodyHeight-val ((m <HighCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader greenball_tracking-msg:bodyHeight-val is deprecated.  Use greenball_tracking-msg:bodyHeight instead.")
  (bodyHeight m))
...
(cl:defmethod euler-val ((m <HighCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader greenball_tracking-msg:euler-val is deprecated.  Use greenball_tracking-msg:euler instead.")
  (euler m))
...
(cl:defmethod yawSpeed-val ((m <HighCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader greenball_tracking-msg:yawSpeed-val is deprecated.  Use greenball_tracking-msg:yawSpeed instead.")
  (yawSpeed m))
...
(cl:defmethod led-val ((m <HighCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader greenball_tracking-msg:led-val is deprecated.  Use greenball_tracking-msg:led instead.")
  (led m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <HighCmd>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'led)))
    (cl:dotimes (i 4)
    (cl:setf (cl:aref vals i) (cl:make-instance 'greenball_tracking-msg:LED))
