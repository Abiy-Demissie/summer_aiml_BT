...
(cl:defmethod cl:initialize-instance :after ((m <BmsState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BmsState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name greenball_tracking-msg:<BmsState> is deprecated: use greenball_tracking-msg:BmsState instead.")))

(cl:ensure-generic-function 'version_h-val :lambda-list '(m))
(cl:defmethod version_h-val ((m <BmsState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader greenball_tracking-msg:version_h-val is deprecated.  Use greenball_tracking-msg:version_h instead.")
  (version_h m))

(cl:ensure-generic-function 'version_l-val :lambda-list '(m))
(cl:defmethod version_l-val ((m <BmsState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader greenball_tracking-msg:version_l-val is deprecated.  Use greenball_tracking-msg:version_l instead.")
  (version_l m))

(cl:ensure-generic-function 'bms_status-val :lambda-list '(m))
(cl:defmethod bms_status-val ((m <BmsState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader greenball_tracking-msg:bms_status-val is deprecated.  Use greenball_tracking-msg:bms_status instead.")
  (bms_status m))

(cl:ensure-generic-function 'SOC-val :lambda-list '(m))
(cl:defmethod SOC-val ((m <BmsState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader greenball_tracking-msg:SOC-val is deprecated.  Use greenball_tracking-msg:SOC instead.")
  (SOC m))

(cl:ensure-generic-function 'current-val :lambda-list '(m))
(cl:defmethod current-val ((m <BmsState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader greenball_tracking-msg:current-val is deprecated.  Use greenball_tracking-msg:current instead.")
  (current m))

(cl:ensure-generic-function 'cycle-val :lambda-list '(m))
(cl:defmethod cycle-val ((m <BmsState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader greenball_tracking-msg:cycle-val is deprecated.  Use greenball_tracking-msg:cycle instead.")
  (cycle m))

(cl:ensure-generic-function 'BQ_NTC-val :lambda-list '(m))
(cl:defmethod BQ_NTC-val ((m <BmsState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader greenball_tracking-msg:BQ_NTC-val is deprecated.  Use greenball_tracking-msg:BQ_NTC instead.")
  (BQ_NTC m))

(cl:ensure-generic-function 'MCU_NTC-val :lambda-list '(m))
(cl:defmethod MCU_NTC-val ((m <BmsState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader greenball_tracking-msg:MCU_NTC-val is deprecated.  Use greenball_tracking-msg:MCU_NTC instead.")
  (MCU_NTC m))

(cl:ensure-generic-function 'cell_vol-val :lambda-list '(m))
(cl:defmethod cell_vol-val ((m <BmsState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader greenball_tracking-msg:cell_vol-val is deprecated.  Use greenball_tracking-msg:cell_vol instead.")
  (cell_vol m))
